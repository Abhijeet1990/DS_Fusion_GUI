...
def supervised_learning(_usecase,_os,_poll_rate, pca, pure_cyber=False, pure_phy=False):
    usecase=_usecase
    os=_os
...
data_as_df,score_as_df = supervised_learning(_usecase,int(_os),int(_pi),pca=enable_PCA,pure_cyber= pc, pure_phy=pp)
